...
class RandomViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, AVSpeechSynthesizerDelegate {
    ...
    var list: [NameWithMeaning] = [] // The list of NameAndHistory (passed from the previous screen)
    
    var filteredNamesBySection = [String: [NameWithMeaning]]() // Dictionary for filtered names
    ...
    var namesBySection = [String: [NameWithMeaning]]() // Dictionary of names organized by section
   // var maindata = String()
    var groupedNames = [String: [NameWithMeaning]]()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellRandom", for: indexPath) as! RandomTableViewCell
